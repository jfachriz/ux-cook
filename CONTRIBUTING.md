## INTRODUCTION
ux-cooks uses debootstrap to pull core Linux packages to build linux traballs, all implementations are developer-friendly and mostly kinda [uxdroid](https://github.com/jfachriz/uxdroid) centric (for now)
...
```bash
do_build "out/uxdroid-test" "arm64"
```
...
# compressing uxdroid-test directory 
do_compress "out/uxdroid-test"
# output would be "out/uxdroid-test.tar.gz"
```
